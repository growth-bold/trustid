    ...
    >
      <div className="mx-auto max-w-[1200px] px-8 py-[92px]">
        <Reveal className="mb-11 grid grid-cols-1 items-end gap-10 md:grid-cols-2">
          <div>
            <Kicker className="text-gold-2">Vai trò &amp; quan hệ thể chế</Kicker>
          ...
          <p className="text-base leading-[1.7] text-[#bcc9dc]">
            Đơn vị thu tiền <b className="font-semibold text-white">không phải</b> là đơn vị tự cấp
            phép cho chính mình. Việc tách bạch này là điều kiện để người uỷ thác yên tâm.
          </p>
        </Reveal>

        <Reveal className="flex flex-col gap-4">
          <div className="flex items-center gap-[22px] rounded-xl border border-[rgba(224,182,74,.3)] bg-[rgba(224,182,74,.1)] px-[26px] py-[22px]">
            <Seal size={58} />
            <div className="flex-1">
              <div className="flex items-center gap-3">
                ...
                <span className="rounded-full border border-[rgba(224,182,74,.4)] px-[9px] py-[3px] text-[11px] font-bold uppercase tracking-[0.06em] text-gold-2">
                  Cơ quan bảo chứng
                </span>
              </div>
              <div className="mt-[5px] text-[14.5px] leading-[1.55] text-[#c3cede]">
          ...
          <div className="flex items-center gap-[22px] rounded-xl border border-white/[.14] bg-white/[.05] px-[26px] py-[22px]">
            <span className="inline-flex h-[58px] w-[58px] shrink-0 items-center justify-center rounded-xl bg-[rgba(12,140,233,.16)]">
              <DuotoneIcon name="padlock-square-1" size={28} color="#0c8ce9" secondaryColor="#9cc9f5" />
            </span>
            <div className="flex-1">
              <div className="flex items-center gap-3">
                <span className="font-serif text-[20px] font-bold text-white">
                ...
                <span className="rounded-full border border-[rgba(12,140,233,.4)] px-[9px] py-[3px] text-[11px] font-bold uppercase tracking-[0.06em] text-[#7fc0f5]">
                  Đơn vị vận hành
                </span>
              </div>
              <div className="mt-[5px] text-[14.5px] leading-[1.55] text-[#c3cede]">
                Đăng ký · Thu hộ · Đối soát · Phân phối — chịu giám sát của hiệp hội
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="flex items-center gap-[18px] rounded-xl border border-white/[.14] bg-white/[.05] px-[22px] py-5">
              <span className="inline-flex h-[50px] w-[50px] shrink-0 items-center justify-center rounded-xl bg-white/[.08]">
                <DuotoneIcon name="user-circle-single" size={26} color="#cdd8e8" secondaryColor="#8ea0ba" />
              </span>
              <div>
                <div className="font-serif text-[17px] font-bold text-white">Chủ thể</div>
            ...
            <div className="flex items-center gap-[18px] rounded-xl border border-white/[.14] bg-white/[.05] px-[22px] py-5">
              <span className="inline-flex h-[50px] w-[50px] shrink-0 items-center justify-center rounded-xl bg-white/[.08]">
                <DuotoneIcon name="office-building-1" size={26} color="#cdd8e8" secondaryColor="#8ea0ba" />
              </span>
              <div>
                <div className="font-serif text-[17px] font-bold text-white">Bên khai thác</div>
                <div className="mt-[3px] text-[13.5px] leading-[1.5] text-[#c3cede]">
